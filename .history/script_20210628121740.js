...
class Mokytojas extends Grupe {
    constructor(vardas, pavarde) {
        super(pavadinimas, trukme);
        this.vardas = "Mokytojas";
        this.pavadinimas = "Mokytojas";
    }
}
...
mokiniai.push(new Mokinys('1 grupe', '1 metai', 'vardenis', 'pavardenis', pazymiuMasyvas, lankomumas ));
mokiniai.push(new Mokinys('1 grupe', '1 metai', 'vardenis1', 'pavardenis1', pazymiuMasyvas, lankomumas ));
mokiniai.push(new Mokinys('1 grupe', '1 metai', 'vardenis2', 'pavardenis2', pazymiuMasyvas, lankomumas ));
mokiniai.push(new Mokinys('1 grupe', '1 metai', 'vardenis3', 'pavardenis3', pazymiuMasyvas, lankomumas ));
mokiniai.push(new Mokinys('1 grupe', '1 metai', 'vardenis4', 'pavardenis4', pazymiuMasyvas, lankomumas ));
