...
class Modelis extends Autombilis {
    ...
    parodykMarkeModeli() {
        ...
        //Autombilis
        // return Autombilis.isveskMarke() + " " + Autombilis.modelis + Autombilis.automobilioAmzius(this.metai); 
        
        return this.isveskMarke() + " " + this.modelis + this.automobilioAmzius(this.metai);  
        return this.isveskMarke() + " " + this.modelis + Modelis.automobilioAmzius(this.metai);  
    }
}
